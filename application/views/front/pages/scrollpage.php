    ...
    <div id="content" class="site-content">
        <div class="full-screen-scroll">
            <ul id="cbp-bislideshow" class="cbp-bislideshow scroll">
                <li style="background-image: url('/assets/front/demo-images/featured-image.jpg');">
                ...
                <li style="background-image: url('/assets/front/demo-images/01.jpg');">
                    <article class="entry-holder">
                        <h2 class="entry-title">
                            <a href="single.html">Whatever is begun in anger ends in shame</a>
                        </h2>
                ...
                <li style="background-image: url('/assets/front/demo-images/02.jpg');">
                    <article class="entry-holder">
                        <h2 class="entry-title">
                            <a href="single.html">Whatever is begun in anger ends in shame</a>
                        </h2>
                ...
                <li style="background-image: url('/assets/front/demo-images/03.jpg');">
                    <article class="entry-holder">
                        <h2 class="entry-title">
                            <a href="single.html">Whatever is begun in anger ends in shame</a>
                        </h2>
